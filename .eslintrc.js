...
module.exports = {
  ...
  // 'parser': 'esprima', // http://eslint.cn/docs/user-guide/configuring#specifying-parser
  'extends': [ // http://eslint.cn/docs/user-guide/configuring#extending-configuration-files
    /**
         * "eslint:recommended" 的 extends 属性启用一系列核心规则，这些规则是经过前人验证的最佳实践（所谓最佳实践，就是大家伙都觉得应该遵循的编码规范），想知道最佳实践具体有哪些编码规范，可以在 eslint规则表 中查看被标记为的规则项。
         * airbnb:号称最严格的规范，包含ECMA 6 + 的 ESLint 代码规范。
         */
    'eslint:recommended'
  ],
  'parserOptions': { // http://eslint.cn/docs/user-guide/configuring#specifying-parser-options
    'parser': 'babel-eslint', // 配合babel-eslint插件使用，一些语法需要用babel转换
    'ecmaVersion': 13, // 默认设置为 3，5（默认）， 你可以使用 6、7、8、9 或 10 来指定你想要使用的 ECMAScript 版本
    'sourceType': 'module' // 设置为 "script" (默认) 或 "module"（如果你的代码是 ECMAScript 模块)
  },
  'globals':{ // http://eslint.cn/docs/user-guide/configuring#specifying-globals
    // 在项目中可以使用process关键字
    'process':true,
    // 在项目中可以使用module关键字
    'module':true
  },
  'rules': { // http://eslint.cn/docs/user-guide/configuring#configuring-rules
